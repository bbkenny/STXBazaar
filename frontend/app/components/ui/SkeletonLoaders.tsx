...
export const BazaarStatsSkeleton = () => (
  <div className="relative overflow-hidden grid grid-cols-2 lg:grid-cols-4 gap-4 w-full">
    {[1, 2, 3, 4].map((i) => (
      <div key={i} className="bg-zinc-900/40 border border-zinc-800/50 p-5 rounded-2xl space-y-2">
...
export const UnlockScheduleSkeleton = () => (
  <div className="space-y-4 w-full">
    {Array.from({ length: 3 }).map((_, i) => (
      <div key={i} className="relative overflow-hidden bg-zinc-900/30 border border-zinc-800/40 p-4 rounded-2xl flex items-center justify-between">
